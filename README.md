...
2. Donlowad the training indices for MNIST/SVHN from [here](https://drive.google.com/drive/folders/1N5VQ8ry-tHr53cXjeBzlPifCcMN1VCsb?usp=sharing)
...
```
3. Tain on SVHN --> MNIST domain adaptation: `python train.py`

**Note:** This implementation works for SVNH --> MNIST (source --> target), I have not tried yet for other datasets.
